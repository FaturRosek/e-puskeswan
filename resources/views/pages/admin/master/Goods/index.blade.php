...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card" style="background: #67e7b642">
                    <div class="card-body">
                        ...
                        data-url="{{route('barang.store')}}" data-target="#add-goods_modal" id="createNewGoods">+ Tambah Data</a>
                    </div>
                </div>
                <div class="search-box">
                    ...
                    <input type="text" data-table-id="goods-table" id="searchBox" data-action="search"
                        class="form-control form-control-solid w-250px ps-13" placeholder="Search Barang" />
                </div>
            </div>
    ...
    @include('pages.admin.master.Goods.modal')
