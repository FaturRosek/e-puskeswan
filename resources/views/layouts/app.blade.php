...
<body>
    <div class="preloader">
        <img src="{{ asset('assets/images/logos/Hospital.png') }}" alt="loader" class="lds-ripple img-fluid" />
    </div>
            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="./index.html" class="text-nowrap logo-img">
                        <img src="{{ asset('assets/images/logos/Hospital.png') }}" class="dark-logo" width="180"
                            alt="" />
